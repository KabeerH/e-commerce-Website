        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          <div className="flex justify-between items-center">
            ...
            <button onClick={() => window.location.href='/'}
              className={`text-blue-800 text-xl font-bold md:text-2xl ${styles.logoButton}`}
          ...
          <div className={`md:flex items-center ${isOpen ? '' : 'hidden'}`}>
            <div className="flex flex-col md:flex-row md:mx-6">
              <button onClick={() => window.location.href='/about'}
                className="my-1 text-sm text-gray-700 font-medium md:mx-4 md:my-0 hover:underline transition duration-200 ease-in-out">About Me
              </button>
              <button onClick={() => window.location.href='/products'}
                className="my-1 text-sm text-gray-700 font-medium md:mx-4 md:my-0 hover:underline transition duration-200 ease-in-out">Products
              </button>
              <button onClick={() => window.location.href='/contact'}
                className="my-1 text-sm text-gray-700 font-medium md:mx-4 md:my-0 hover:underline transition duration-200 ease-in-out">Contact
              </button>
